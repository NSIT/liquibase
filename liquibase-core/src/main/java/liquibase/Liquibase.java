...
public class Liquibase {
    ...
    private void outputHeader(String message) throws DatabaseException {
        ...
        if (database instanceof MSSQLDatabase) {
            ...
            executor.execute(new RawSqlStatement("SET ANSI_NULLS, ANSI_PADDING, ANSI_WARNINGS, ARITHABORT, CONCAT_NULL_YIELDS_NULL, QUOTED_IDENTIFIER ON;"));
            executor.execute(new RawSqlStatement("SET NUMERIC_ROUNDABORT OFF;"));
    ...
    private void outputFooter() throws DatabaseException {
        Executor executor = ExecutorService.getInstance().getExecutor(database);
        if (database instanceof MSSQLDatabase) {
            boolean origErrorHandlingEnabled = LoggingExecutor.isErrorHandlingEnabled();
            try {
                LoggingExecutor.setErrorHandlingEnabled(false);
                ...
                LoggingExecutor.setErrorHandlingEnabled(origErrorHandlingEnabled);
            }
        }
    }
